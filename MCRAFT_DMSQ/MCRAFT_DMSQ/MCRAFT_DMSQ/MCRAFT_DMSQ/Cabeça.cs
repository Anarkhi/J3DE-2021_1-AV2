...
namespace MCRAFT_DMSQ
{
    public class Cabeça
    {
        ...
        BasicEffect effect;
        Game1 G1;
        public Cabeça(GraphicsDevice device)
        {
            this.device = device;
            ...
            new VertexPositionColor(new Vector3(0.25f, -0f, 0), Color.Brown),  //Frente T0.25ff-T2
                new VertexPositionColor(new Vector3(-0.25f, -0f, 0), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, 1f, 0), Color.Brown),

                new VertexPositionColor(new Vector3(0.25f, 1f, 0), Color.Brown),
                new VertexPositionColor(new Vector3(0.25f, -0f, 0), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, 1f, 0), Color.Brown),

                new VertexPositionColor(new Vector3(0.25f, -0f, -0.25f), Color.Brown),   //Fundos T3-T4
                new VertexPositionColor(new Vector3(-0.25f, -0f, -0.5f), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, 1f, -0.25f), Color.Brown),

                new VertexPositionColor(new Vector3(0.25f, 1f, -0.25f), Color.Brown),
                new VertexPositionColor(new Vector3(0.25f, -0f, -0.25f), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, 1f, -0.25f), Color.Brown),

                new VertexPositionColor(new Vector3(-0.25f, 1f, -0.25f), Color.Brown),   //Janela Lá T5-T6
                new VertexPositionColor(new Vector3(-0.25f, -0f, -0.25f), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, -0f, 0), Color.Brown),
                ...
                new VertexPositionColor(new Vector3(0.25f, 1f, -0.25f), Color.Brown),   //Janela Cá T7-T8
                new VertexPositionColor(new Vector3(0.25f, -0f, -0.25f), Color.Brown),
                new VertexPositionColor(new Vector3(0.25f, -0f, 0), Color.Brown),
                ...
                new VertexPositionColor(new Vector3(0.25f, 1f, 0), Color.Brown),   //Teto T9-T0.25f0
                new VertexPositionColor(new Vector3(-0.25f, 1f, 0), Color.Brown),
                new VertexPositionColor(new Vector3(-0.25f, 1f, -0.25f), Color.Brown),
                };
